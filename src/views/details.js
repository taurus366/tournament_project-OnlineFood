...
const detailTemplate = (isAdmin,onDelete,authToken,food) => html`
    <section id="details">
        <h1>Име: ${food.name}
        ...
        <div class="article-details">
            ...
            <div class="article-description">
                ...
                ${authToken != null ? isAdmin === 'ADMIN' ? html`
                    ...
                    <button id="addCart" class="button danger">Добави в кошницата</button>` : ''}
...
export async function detailsPage(context) {
    ...
    food = await getFoodById(itemId);

  await  context.render(detailTemplate(isAdmin,onDelete,authToken,food));
